...
<body background="picture/back/center.png">
	<%
  		...
  		String sql = "select * from orderform_" + userId;
	...
	<%
  		...
  		%>
	<table style="margin-left:15px; text-align:center" height="30px" cellspacing="0px" cellpadding="0px" align="center" border=1 bordercolor="white" width="1300px"
		 >
		 <tr bgcolor="#66CD00">
				<td ><font
				...
				<td ><font
					style="color:#FFF;font-size:20px;">交易时间</font>
				</td>
				<td ><font
		...
		<tr>
			...
			<td ><a style="text-decoration:none;color:red" href="deleteOrder.jsp?userId=<%=userId %>&orderId=<%=list2.get(j).getOrderId() %>&type=order" style="text-decoration:none">删除订单</a></td>
		</tr>
		<%
	    			}
	    		}
