...
<div class="login" style="margin-top: 50px;margin-left: 300px">
	<%
		String sql = "";
		ResultSet rs = null;
		int id = 0;
		...
		id = Integer.parseInt(request.getParameter("backGoodID"));
			...
			<tr><td><font style="font-size:15px;">&nbsp;&nbsp;&nbsp;库存 <%=bookCount %> 册</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="backEdit.jsp?editType=goods&backID=<%=id %>"
					target="backCenter" style="text-decoration:none;"><input type="button" value="编辑" style="height:30px"></a></td></tr>
			</table>
			<br />
